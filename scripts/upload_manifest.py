...
def main():
    ...
    osv = subprocess.Popen('cd ../..; scripts/run.py --vnc none -m 512 --trace=nc* -c1 -i %s -u -s -e "--norandom --noinit /tools/cpiod.so" --forward tcp:10000::10000' % image_path, shell = True, stdout=subprocess.PIPE)
